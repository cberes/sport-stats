...
(hr.passing_offense * vr.passing_defense) as 'a',
(hr.rushing_offense * vr.rushing_defense) as 'b',
(vr.passing_offense * hr.passing_defense) as 'c',
(vr.rushing_offense * hr.rushing_defense) as 'd'
from game g
