...
(hr.passing_offense - (1.0 / vr.passing_defense)) as 'a',
(hr.rushing_offense - (1.0 / vr.rushing_defense)) as 'b',
(vr.passing_offense - (1.0 / hr.passing_defense)) as 'c',
(vr.rushing_offense - (1.0 / hr.rushing_defense)) as 'd'
from game g
